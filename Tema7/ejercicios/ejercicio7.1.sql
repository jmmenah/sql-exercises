...
SELECT * FROM Asignatura WHERE Curso IN("4-ESO","3-ESO","2-ESO");
...
SELECT * FROM Asignatura WHERE Código BETWEEN 3 AND 6;
...
SELECT NIF,CONCAT_WS(' ',Nombre, Apellido1, Apellido2) AS "Nombre Completo", Dirección, Telefono FROM Alumno;
...
SELECT * FROM Alumno WHERE Apellido1 LIKE '________%a';
...
SELECT * FROM Asignatura LIMIT 2,3;
